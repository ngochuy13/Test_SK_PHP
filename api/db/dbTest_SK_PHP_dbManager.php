...
function getConnection() {
	...
	global $db_Test_SK_PHP_db_Url, $db_Test_SK_PHP_db_User, $db_Test_SK_PHP_db_Pass, $db_Test_SK_PHP_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_Test_SK_PHP_db_Url.";dbname=".$db_Test_SK_PHP_db_DbName, $db_Test_SK_PHP_db_User, $db_Test_SK_PHP_db_Pass);
